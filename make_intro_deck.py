...
def build():
    ...
    text(s, MARGIN, Inches(1.68), BODY_W, Inches(0.6),
         [('이 시스템이 하는 일 자체는 분야를 가리지 않습니다. 법령 원문을 근거로 답하고, 뉴스·법안·회의록에서 '
           '중요한 것만 골라 알리는 구조는 어느 분야에나 그대로 적용됩니다.',
           12.5, False, INK)], line_spacing=1.35)
    cards(s, [
        ('지금의 한계',
         "'무엇을 중요하게 볼지'가 지금은 전파·전기통신 기준으로 짜여 있고, 그 기준이 설정값이 아니라 코드에 들어가 있습니다.\n\n"
         '그래서 다른 팀에 맞추는 일은 설정 변경이 아니라 개발이고, 한 번에 여러 팀을 열지 못합니다.'),
        ('어떻게 나눌지 정리 중입니다',
