...
9/3 SKT 탈락(네이버클라우드 컨소시엄 선정)이라는 결정적 변화가 요약·정의문에 없었고 AIDC·GSMA 기사 12건이
...
"제출해야 한다"로, #9·#10 이해관계자 노트가 9/3 선정 결과 이전 상태("9월 결과 발표 예정", "2~3곳 선정")로,
...
독파모 계보 문서가 9/3 선정 결과 이전 상태. 조치: DB 본문·노트·링크 정정(링크 해제 60건, "제안 N 병합 이관"
