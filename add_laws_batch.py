...
TARGETS = [
    ...
    # ── H. 관계도 2층 전수 재검토에서 "KB 원문이 없어 답할 수 없다"로 걸린 것 (2026-09-14) ──
    # 73개 주제를 조문 원문과 대조하는 과정에서, 인용은 실재하는데 KB에 원문이 없어
    # 30자 인용 요건을 못 채운 법령들. 각 항목 뒤 [ ]는 막혀 있던 질문.
    ("중소기업기본법", "중소기업기본법", "law"),                       # [알뜰폰 전파사용료 차감 대상 판정 — 영 제90조①단서]
    ("중견기업 성장촉진 및 경쟁력 강화에 관한 특별법", "중견기업법", "law"),  # [〃]
    ("공공자금관리기금법", "공공자금관리기금법", "law"),                 # [주파수 할당대가 분할납부 이자율 — 할당대가고시 제7조③]
    ("국가기술자격법", "국가기술자격법", "law"),                        # [무선종사자 자격 — 전파법 제70조①]
    ("전기통신금융사기 피해 방지 및 피해금 환급에 관한 특별법", "전기통신금융사기법", "law"),   # [번호 역무중지·사기정보제공기관]
    ("전기통신금융사기 피해 방지 및 피해금 환급에 관한 특별법 시행령", "전기통신금융사기법_시행령", "law"),
    ("장애인차별금지 및 권리구제 등에 관한 법률", "장애인차별금지법", "law"),  # [통신중계서비스 뿌리 — 제21조④]
    ("금지행위 위반에 대한 고발기준", "전기통신사업법", "admrul"),        # [노드는 있으나 본문 0건]
]
