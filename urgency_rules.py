...
# 표는 자동으로 따라오지 않으므로 **표의 공통 규칙을 고치면 이 사본도 같이 고칠 것** — 사내판도 다리 반입이 실패하면
# 이 사본으로 돈다(2026-09-25 사내 공통 규칙 삭제 뒤). 규칙 id는 영구 불변 — 이름을 바꿔도 id 유지.
...
URGENCY_RULES_FALLBACK = [
    ...
    {'id': 'ministry_personnel', 'position': 30, 'mode': 'min', 'level': '보통',
     ...
     'none_words': ['인사말', '인사이드'],   # 「인사말하는 장관」·「디시인사이드」 오탐 8건(60일 실측, 2026-09-25 사내 요청 + 운영자 결정)
