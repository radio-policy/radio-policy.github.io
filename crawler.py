...
def send_morning_telegram(items: list, briefing_text: str = ''):
    ...
    if briefing_text:
        ...
        if len(briefing_text) > 4000:
            text += '\n\n...(전문은 대시보드 참조)'
        text += '\n\n📊 https://radio-policy.github.io/?p=briefing'
    else:
        # 폴백: 원시 목록 발송
        ...
        for label, icon, group in [('긴급', '🔴', urgent), ('보통', '🟡', normal), ('참고', '🟢', ref)]:
            if group:
                ...
                lines.append('')
        lines.append('📊 https://radio-policy.github.io/?p=briefing')
        text = '\n'.join(lines)
...
<hr>
<p style="color:#999;font-size:12px">
대시보드: <a href="https://radio-policy.github.io/?p=briefing">바로가기</a>
</p>
</body></html>'''
    elif briefing_text:
...
대시보드: <a href="https://radio-policy.github.io/?p=briefing">https://radio-policy.github.io/?p=briefing</a>
</p>
</body></html>'''
    else:
