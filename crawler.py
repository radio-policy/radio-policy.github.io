...
- **제도가 실제로 움직인 것** — 법·시행령·고시·기준의 제개정과 시행, 정부·위원회의 의결·처분·행정지도,
  국회의 법안 처리, 요금·약관 규제, 이용자보호 의무·평가, 무선국·통신설비 제도 변경
...
- **통신사·통신망을 겨냥한 대규모 침해사고·개인정보 유출**
- **플랫폼·부가통신 사업자의 개인정보 사건 중 정부가 전기통신사업법·정보통신망법으로 조사·제재·법적
  책임을 검토한다고 밝힌 것** (예: 검색사업자의 디지털성범죄 피해자 정보 노출과 정부의 책임 추궁)
- **이동통신 품질·기지국·공공 와이파이의 장애·사고·민원·비판 보도**
  (성과 홍보·구축 완료·절감 효과 같은 긍정적 내용은 제외)
...
- 경쟁사의 개별 경영 사안, 통신사가 당사자가 아닌 해킹·유출 사건
...
- **정부·기관의 공모전·캠페인·시상·홍보성 발표** (전자파 공모전 등)
  ⚠️ 다만 **수상·우수사례 형식이어도 제도 변경이나 정부-통신사 공동 사업이 본론이면 내리지 않는다**
     (예: "망중립성 예외 적용, 소방관 통신 우선" 보도는 제도 사안이라 금주검토 이상)
