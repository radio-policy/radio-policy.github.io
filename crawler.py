...
_URGENCY_CRITERIA = """[제1원칙 — 주체와 파급] 같은 사안이라도 당사자가 누구냐에 따라 등급이 다르다.
아래 개별 기준보다 이 원칙을 먼저 적용한다.
- **SK텔레콤이 당사자:**
  · 부정적·문제적 사안 → **즉시대응** (사안 규모와 무관하게. 과징금·제재·소송·장애·해킹·
    점유율 하락·불공정 논란·비판 보도 등)
  · 상장·투자·수주·실적 등 재무 이벤트 → **즉시대응**
  · 요금제·단말·부가서비스 출시, 제휴, 마케팅 등 **일상적 영업 활동 → 금주검토**
    ⚠️ 다만 **요금 인상·약관 변경처럼 이용자 부담이나 규제 쟁점이 걸릴 수 있으면 즉시대응**
    (같은 "요금제 출시"라도 이용자보호·규제 사안이 되면 등급이 올라간다)
- **KT·LG유플러스 등 경쟁 통신사가 당사자 → 기본 등급 유지.**
  ⚠️ 다만 **우리 회사로 번질 수 있는 리스크는 즉시대응으로 올린다** — 업계 공통 규제·제도
  변경으로 이어질 사안, 동일 설비·기술·관행에서 비롯된 사고, 정부의 통신사 전수조사·일괄
  점검, 국회·시민단체가 통신사 전반을 겨냥한 문제 제기 등.
  **"우리도 같은 지적을 받을 수 있는가"로 판단한다.**
- **통신장비사·타 업종·공공기관이 당사자 → 한 단계 내린다.**

⚠️ **낱말이 아니라 대상을 볼 것.** '사고·장애·누출·중계기' 같은 낱말이 들어 있어도
   **이동통신·전파 설비에서 일어난 일인지**를 먼저 확인한다. 아니면 등급을 올리지 않는다.
   (실제 오분류: 아이스크림 공장 냉동설비 암모니아 '누출' → 긴급 / 터널 라디오 '중계기'
    고장 → 이동통신 중계기가 아님)
...
⚠️ 주의: 성과 홍보·절감 효과·구축 완료 등 긍정적 내용은 즉시대응 제외
   (단 SKT가 당사자면 제1원칙이 우선한다)

금주검토:
- 이동통신·전파·주파수 관련 정책 동향·기술 소개·통계 기사
- 입법예고·개정안·정책 발표 등 향후 영향을 줄 수 있는 기사
- 공공 와이파이 구축·확대·성과 관련 정보성 기사
- 통신사·통신망이 당사자가 아닌 해킹·유출 사건(타 업종·공공기관 대상) —
  보안 위협 동향으로 볼 가치는 있으나 즉시 대응 사안은 아니다

동향파악:
- 위 두 기준에 해당하지 않는 해외 동향·업계 트렌드·참고용 기사
- 이미 종결된 사건의 판결·구속·수사결과 등 사후 보도
- 상장·투자유치·수주·실적 등 기업 재무 이벤트(통신장비사·그 외 기업)"""
...
❌ 제외: 스포츠·연예·부동산 등 이동통신·전파와 무관한 분야의 용어 (예: 연속 선발, 홈런, 득점 등)
