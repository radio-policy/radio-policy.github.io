...
TEXT = (
    '📢 <b>정책 AI도우미에 새 텔레그램 알림(PUSH) 항목이 추가되었습니다</b>\n\n'
    '📺 <b>방미통위 동향</b>\n'
    '방송미디어통신위원회 <b>회의 의사일정</b>(회의 전날 게시)과 <b>위원회 결과</b>(회의 당일 게시)를 중심으로 '
    '게시 직후 텔레그램 알림으로 보내드립니다. 의사일정은 안건 표 전체, 위원회 결과는 안건별 의결 요지와 원문 링크입니다. '
    '그 밖의 방미통위 보도자료는 통신·전파 정책 관련 건만 제목과 본문 앞부분으로 함께 옵니다.\n\n'
