...
BOT_DESC = (
    ...
    '📡 모닝 브리핑 · 🚨 긴급 뉴스 · 🏛️ 법안 동향 (선택한 시각에 한 번에 도착)\n'
    '📖 법령 검색 — 예: /law 전기통신사업법 19조\n'
    '🤖 AI 자문 — /ask 질문 (운영자 최초 1회 승인 필요)\n\n'
...
COMMANDS = [
    ...
    {'command': 'law',      'description': '법령 검색 (예: /law 전기통신사업법 19조)'},
    {'command': 'ask',      'description': 'AI 자문 (운영자 최초 1회 승인 필요)'},
